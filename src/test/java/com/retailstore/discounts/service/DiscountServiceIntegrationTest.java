...
public class DiscountServiceIntegrationTest {
	...
	public void applyPercentageAndAmountDiscount() {
		DiscountedBillDto discountedBillDto = discountService.applyDiscount(TestHelper.createPrincipal(TestHelper.EMPLOYEE_ACC, TestHelper.COMMON_PASSWORD, null), TestHelper.createBillDto(BigDecimal.valueOf(150), false));
	...
	public void applyOnlyAmountDiscount() {
		DiscountedBillDto discountedBillDto = discountService.applyDiscount(TestHelper.createPrincipal(TestHelper.CUSTOMER_ACC, TestHelper.COMMON_PASSWORD, null), TestHelper.createBillDto(BigDecimal.valueOf(150), false));
		Assert.assertEquals(discountedBillDto.getBill(), BigDecimal.valueOf(150));
	...
	public void applyLongTermDiscount() {
		DiscountedBillDto discountedBillDto = discountService.applyDiscount(TestHelper.createPrincipal(TestHelper.CUSTOMER_LONGTERM_ACC, TestHelper.COMMON_PASSWORD, null), TestHelper.createBillDto(BigDecimal.valueOf(150), false));
		Assert.assertEquals(discountedBillDto.getBill(), BigDecimal.valueOf(150));
	...
	public void applyOnlyLongTermDiscount() {
		DiscountedBillDto discountedBillDto = discountService.applyDiscount(TestHelper.createPrincipal(TestHelper.CUSTOMER_LONGTERM_ACC, TestHelper.COMMON_PASSWORD, null), TestHelper.createBillDto(BigDecimal.valueOf(50), false));
